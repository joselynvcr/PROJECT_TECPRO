...
public class FormAdministrador extends JFrame implements ActionListener {
	...
	public FormAdministrador(CredencialesBE cred) {
		...
		MAINpanelADMIN.setBounds(0, 92, 279, 508);
		contentPane.add(MAINpanelADMIN);
		
		lblNewLabel_1_nombreAndApe = new JLabel(cred.getNombreEmpleado()+" "+ cred.getApellidoEmpleado());
		lblNewLabel_1_nombreAndApe.setBounds(78, 150, 123, 23);
		
		lblNewLabel_cargo = new JLabel(cred.getTipoCargo().toUpperCase());
		lblNewLabel_cargo.setBounds(78, 178, 123, 33);
		lblNewLabel_cargo.setHorizontalAlignment(SwingConstants.CENTER);
		
		lblNewLabel = new JLabel("");
		lblNewLabel.setBounds(78, 11, 134, 128);
		lblNewLabel.setIcon(new ImageIcon("D:\\UPN-CICLOS-ARCHIVOS\\V CICLO_SISTEMAS_poo-electricidad-base de datos\\PROJECT_TECPRO\\PROJECT_SOFTWARE\\SABOREA\\img\\user-icon.png"));
		
		btnLISTAR_EMPLEADOS =new JButton("LISTA EMPLEADOS");
		...
		btnLISTAR_EMPLEADOS.setBounds(1, 241, 277, 49);
		...
		btnLISTAR_EMPLEADOS.setIcon(new ImageIcon("D:\\UPN-CICLOS-ARCHIVOS\\V CICLO_SISTEMAS_poo-electricidad-base de datos\\PROJECT_TECPRO\\PROJECT_SOFTWARE\\SABOREA\\img\\list_task_tasklist_checklist_check_icon_145964.png"));
		...
		btnRegistrarEmpleado.setIcon(new ImageIcon("D:\\UPN-CICLOS-ARCHIVOS\\V CICLO_SISTEMAS_poo-electricidad-base de datos\\PROJECT_TECPRO\\PROJECT_SOFTWARE\\SABOREA\\img\\business_application_addmale_useradd_insert_add_user_client_2312.png"));
		...
		btnRegistrarEmpleado.setBounds(0, 297, 278, 49);
		...
		btnCerrarSesin.setIcon(new ImageIcon("D:\\UPN-CICLOS-ARCHIVOS\\V CICLO_SISTEMAS_poo-electricidad-base de datos\\PROJECT_TECPRO\\PROJECT_SOFTWARE\\SABOREA\\img\\login_icon_151220.png"));
		...
		MENUpanel.setBounds(0, 0, 1000, 96);
